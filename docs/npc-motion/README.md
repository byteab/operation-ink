...
The hostage is green (`#229447`) and runs at 2.6 m/s (previously 2.05). Enemy running is 4.2 m/s (previously 3.36); patrol walking is unchanged. Escort animation follows measured horizontal travel, and enemy running uses the shared 1.5× stride/cadence adaptation.
