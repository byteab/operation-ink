...
- Brief directional edge shading and an “Incoming” label recover within 650 ms of quiet. The view centre stays clear, effects remain bounded under sustained fire, and Reduced Motion retains the text without the pressure shading. Existing mute, volume, pause, restart, checkpoint and VR behavior is preserved.
