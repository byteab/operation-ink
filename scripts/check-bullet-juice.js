...
(async () => {
  ...
  check(!document.querySelector('.mission-threat').hidden && m.hud.incoming.strength > 0, 'Near miss reaches peripheral pressure and directional caption')
  capture(5, 'Incoming · clear centre / peripheral pressure')
